...
class TsneDimRed(DimRed):
    ...
    def fit(self, X):
        self.model = Parametric_tSNE(num_inputs=X.shape[1], num_outputs=2, perplexities=30, batch_size=8) # para la base de datos iris, se tuvo que ajustar el batch_size sino salian malos resultados visuales. 
        self.model.fit(X)
